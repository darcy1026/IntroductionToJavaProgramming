...
public class Question23 {
	...
	public static void main(String[] args) {
		 ...
		 * or equal to 5.0 / 2. Test your program to cover all cases.) Here are two
		 * sample runs.
		 */
		...
		boolean inTheRectangle = (Math.abs(x) <= 5 && Math.abs(y) <= 2.5 );
		System.out.println("Point (" + x + ", " + y + ") is " + ((inTheRectangle) ? "in " : "not in ") + "the rectangle." );
